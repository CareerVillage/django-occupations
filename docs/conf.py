...
"""
django-occupations documentation build configuration file.
...
project = 'django-occupations'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'django-occupations'
...
#
# html_title = 'django-occupations v0.1.0'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'A reusable Django App for importing, updating, and managing structured occupation data.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'django_occupations'),
                os.path.join(root_path, 'django_occupations/migrations')])
